...
<html lang="en">
    ...
    <body>
        <header>
        <h1>Marcus King's IT161 Portal Website</h1>
        <nav class="topnav" id="myTopnav">
            ...
            <a href="http://web-students.net/site116/it161/contact.php">Contact Marcus</a>
        ...
        <div class="wrapper">
            ...
            <footer>
                <p><small>&copy; 2022 by 
                    <a href="contact.php">Marcus King</a>, All Rights Reserved.</small>
                </p>
                <p><small>
